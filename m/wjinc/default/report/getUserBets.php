...
$Date=$_POST['date'];
$elemet=isset($_POST['elemet']) ? $_POST['elemet'] : '#listPage';
$settled=isset($_POST['settled']) ? $_POST['settled'] : 'true';
...
// $list=$this->getPage("select * from {$this->prename}bets where  isDelete=0 and uid=617 {$sql}",$pagenum,15);
// var_dump("select * from {$this->prename}bets where  isDelete=0 and uid=617 {$sql}");
// exit;
// var_dump($pagenum);
// var_dump($pagesize);
// var_dump($list['data']);
