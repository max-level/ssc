...
//					console.log(obj);
				...
				for(var i in onlineData) {
					...
					// 闪付,银行在线支付
					if(obj.onlineType == 2) {
						bankOnlinePayList.push({id: obj.id, onlineType: obj.onlineType, payCode: 'ICBC-WAP', domain:obj.domain});
					}
						...
						alipayOnlineList.push({id: obj.id, onlineType: obj.onlineType, payCode: 'alipay', domain:obj.domain});
					}
					...
					else if (obj.onlineType == 9) { //微信支付
						weixinOnlinePayList.push({id: obj.id, onlineType: obj.onlineType, payCode: 'weixin', domain:obj.domain});
					}
