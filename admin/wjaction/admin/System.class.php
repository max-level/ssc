...
class System extends AdminBase{
	...
	//协议设置
	public final function xieyishezhi(){
		$this->display('system/xieyi.php');
	}
	// 推送信息相关方法
	...
	public final function message_add(){
		$this->display('system/message_add.php');
	}

	// 黑名单管理
	public final function stop_ip(){
		$this->display('system/stop_ip.php');//黑名单IP列表
	}
	public final function stop_ip_add(){
		$this->display('system/stop_ip_add.php');//黑名单IP添加
	}
	public final function stop_bankcard(){
		$this->display('system/stop_bankcard.php');//银行卡黑名单列表
	}
	public final function stop_bankcard_add(){
		$this->display('system/stop_bankcard_add.php');//银行卡黑名单添加
	}
	...
	public final function alipay_list(){
		$this->display('system/bank-list-alipay.php');
	}
	public final function weixin_list(){
		$this->display('system/bank-list-weixin.php');
	}
	public final function qq_list(){
		$this->display('system/bank-list-qq.php');
	}		
	public final function bank1_list(){
		$this->display('system/bank-list-bank.php');
	}		
        ...
        if (!empty($_FILES["file"]["name"])) {
            ...
            )
            {
                ...
                else
                {
                    ...
                    $mPath = dirname($_SERVER['DOCUMENT_ROOT']) . "/wap/upload/file/";
