...
class user extends Object{
	...
	public final function logined(){
		header('content-Type: text/html;charset=utf8');
		$this->display('logined369912.php');
	}
	...
	public final function checkLogin(){
		...
		$_SESSION['LUSN']=serialize($user);
		
		// 把别人踢下线
		$this->update("update ssc_sysadmin_session set isOnLine=0 where uid={$user['uid']} and id < {$user['sessionId']}");
