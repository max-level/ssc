	...
	<table class="tablesorter" cellspacing="0">
		...
		?>
			<tr>
				...
				?>
                <td>
                <a href="/admin778899.php/manage/pwdManagerModal/<?=$var['uid']?>" target="ajax" call="manageChangePwdModal">修改密码</a>
				...
				?>
                <td><a href="/admin778899.php/manage/pwdManagerModal/<?=$var['uid']?>" target="ajax" call="manageChangePwdModal">修改密码</a> | <a href="/admin778899.php/manage/deleteManager/<?=$var['uid']?>" target="ajax" call="manageDeleteManager" dataType="json">删除</a>
                <?php if ($this->user['uid'] == 1){?>

                 | <a href="/manage/permission/<?=$var['uid']?>">权限设置</a>
                 <?php } ?>
                </td>
                 <?php
				}
