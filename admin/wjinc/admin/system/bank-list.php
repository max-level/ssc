<?php
	$sql="select * from {$this->prename}sysadmin_bank where admin=1 and rechtype != 'alipay' and rechtype != 'weixin' and rechtype != 'cft'";
	$data=$this->getPage($sql, $this->page, $this->pageSize);
?>
<article class="module width_full">
<input type="hidden" value="<?=$this->user['username']?>" />
	<header>
		<h3 class="tabs_involved">收款类型设置&nbsp;&nbsp;<font color="red" size=3><B>(注意：收款二维码图片名称不可以包括中文和特殊符号)</B></font>
