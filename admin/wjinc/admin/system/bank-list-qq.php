<?php
	$sql="select * from {$this->prename}sysadmin_bank where admin=1 and rechtype = 'cft' ORDER BY id DESC";
	$data=$this->getPage($sql, $this->page, $this->pageSize);
?>
<article class="module width_full">
<input type="hidden" value="<?=$this->user['username']?>" />
	<header>
		<h3 class="tabs_involved">QQ钱包转帐设置&nbsp;&nbsp;<font color="red" size=3><B>(注意：收款二维码图片名称不可以包括中文和特殊符号)</B></font>
