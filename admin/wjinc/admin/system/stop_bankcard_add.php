...
<header><h3 class="tabs_involved">添加银行卡黑名单</h3></header>
<table width="100%">
<tr><td>
<form action="/admin778899.php/Member/doAddbankcard" method="post" target="ajax" call="sysReloadNotice1">
		<table class="tablesorter table2" cellspacing="0" width="100%">
			
			<tr>
				<td><span class="aq-txt">姓名：</span></td>
				<td align="left"><div align="left"><input type="text" name="stop_name" style="width:200px;" value="" /></div></td>
			</tr>
			<tr>
				<td><span class="aq-txt">银行卡号：</span></td>
				<td align="left"><div align="left"><input type="text" name="stop_bankcard" style="width:200px;" value="" /><font color="red">&nbsp;&nbsp;请注意银行卡号的正确格式。</font></div></td>
			</tr>
			<tr>
