...
class Biapi extends JoDES{
	...
	配置参数
	*/
	//protected $key='iSn&8.$4';                                     //站点秘钥
	
	//protected $WebSiteCode='aa418181-69e5-487c-bab5-526857c6eb0c'; //站点code
	
	//protected $password='aABb123Bb'; 								//站点用户密码
	protected $key='u1pDoEBb';                                     //站点秘钥
	
	protected $WebSiteCode='8f1a964b-d09b-43e0-a4eb-74ec9c10bde4'; //站点code
	
	protected $password='a123456'; 								//站点用户密码
