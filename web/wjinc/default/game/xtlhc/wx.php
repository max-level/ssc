...
<script type="text/javascript">
	var CONFIG_MAP=parent.CONFIG_MAP;
</script>
<!--main-->
...
<div id="subpage"> 
   <div class="cont-col3"> 
    ...
    <div class="cont-col3-bd" id="bet_tab"> 
    	<div class="cont-col3-bd" id="bet_tab"> 
    		<table class="u-table2 play_tab_93 "> 
		      <thead> 
		       <tr> 
		      ...
		      <tbody> 
		       <tr> 
		        <td id="play_name_709301" class="name">金</td> 
		        <td id="play_desc_709301" class="qiu">
		        	<script type="text/javascript">LHC.getLhcWxStr("lhcWxJin","#play_desc_709301")</script>
		        </td> 
		        <td id="play_odds_709301" class="odds"><span class="c-txt3">--</span></td> 
		        <td id="play_text_709301" class="amount"><input type="text" /></td> 
		       </tr> 
		       <tr> 
		        <td id="play_name_709302" class="name">木</td> 
		        <td id="play_desc_709302" class="qiu">
		        	<script type="text/javascript">LHC.getLhcWxStr("lhcWxMu","#play_desc_709302")</script>
		        </td> 
		        <td id="play_odds_709302" class="odds"><span class="c-txt3">--</span></td> 
		        <td id="play_text_709302" class="amount"><input type="text" /></td> 
		       </tr> 
		       <tr> 
		        <td id="play_name_709303" class="name">水</td> 
		        <td id="play_desc_709303" class="qiu">
		        	<script type="text/javascript">LHC.getLhcWxStr("lhcWxShui","#play_desc_709303")</script>
		        </td> 
		        <td id="play_odds_709303" class="odds"><span class="c-txt3">--</span></td> 
		        <td id="play_text_709303" class="amount"><input type="text" /></td> 
		       </tr> 
		       <tr> 
		        <td id="play_name_709304" class="name">火</td> 
		        <td id="play_desc_709304" class="qiu">
		       		 <script type="text/javascript">LHC.getLhcWxStr("lhcWxHuo","#play_desc_709304")</script>
		        </td> 
		        <td id="play_odds_709304" class="odds"><span class="c-txt3">--</span></td> 
		        <td id="play_text_709304" class="amount"><input type="text" /></td> 
		       </tr> 
		       <tr> 
		        <td id="play_name_709305" class="name">土</td> 
		        <td id="play_desc_709305" class="qiu">
		        	<script type="text/javascript">LHC.getLhcWxStr("lhcWxTu","#play_desc_709305")</script>
		        </td> 
		        <td id="play_odds_709305" class="odds"><span class="c-txt3">--</span></td> 
		        <td id="play_text_709305" class="amount"><input type="text" /></td> 
		       </tr> 
		      </tbody> 
		     </table> 
    	</div>
