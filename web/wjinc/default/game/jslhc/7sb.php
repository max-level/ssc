...
<div class="main clearfix">
   ...
   <div class="cont-col3"> 
    ...
    <div class="cont-col3-bd" id="bet_tab"> 
    	<div class="cont-col3-bd" id="bet_tab"> 
    		<table class="u-table2 play_tab_96 "> 
		      <thead> 
		       <tr> 
		      ...
		      <tbody> 
		       <tr> 
		        <td id="play_name_709601" class="name">红波</td> 
		        <td id="play_odds_709601" class="odds"><span class="c-txt3">--</span></td> 
		        <td id="play_text_709601" class="amount"><input type="text" /></td> 
		        <td id="play_name_709602" class="name">蓝波</td> 
		        <td id="play_odds_709602" class="odds"><span class="c-txt3">--</span></td> 
		        <td id="play_text_709602" class="amount"><input type="text" /></td> 
		       </tr> 
		       <tr> 
		        <td id="play_name_709603" class="name">绿波</td> 
		        <td id="play_odds_709603" class="odds"><span class="c-txt3">--</span></td> 
		        <td id="play_text_709603" class="amount"><input type="text" /></td> 
		        <td id="play_name_709604" class="name">和局</td> 
		        <td id="play_odds_709604" class="odds"><span class="c-txt3">--</span></td> 
		        <td id="play_text_709604" class="amount"><input type="text" /></td> 
		       </tr> 
		      </tbody> 
		     </table> 
    	</div>
