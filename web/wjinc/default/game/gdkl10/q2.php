...
<div class="main clearfix">
  ...
  <div id="subpage"> 
   <div class="cont-col3 klsf"> 
    ...
    <table class="u-table2 play_tab_76 K3Term"> 
      <thead> 
       <tr> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_607629" class="name">东</td> 
        <td id="play_odds_607629" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607629" class="amount"><input type="text" /></td> 
        
        <td id="play_name_607630" class="name">南</td> 
        <td id="play_odds_607630" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607630" class="amount"><input type="text" /></td>
         
        <td id="play_name_607631" class="name">西</td> 
        <td id="play_odds_607631" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607631" class="amount"><input type="text" /></td>
         
        <td id="play_name_607632" class="name">北</td> 
        <td id="play_odds_607632" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607632" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_607633" class="name">中</td> 
        <td id="play_odds_607633" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607633" class="amount"><input type="text" /></td> 
        
        <td id="play_name_607634" class="name">发</td> 
        <td id="play_odds_607634" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607634" class="amount"><input type="text" /></td>
         
        <td id="play_name_607635" class="name">白</td> 
        <td id="play_odds_607635" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607635" class="amount"><input type="text" /></td>
