...
<div class="main clearfix">
  ...
  <div id="subpage"> 
   <div class="cont-col3 klsf"> 
    ...
    <table class="u-table2 play_tab_77 K3Term"> 
      <thead> 
       <tr> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_607729" class="name">东</td> 
        <td id="play_odds_607729" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607729" class="amount"><input type="text" /></td> 
        
        <td id="play_name_607730" class="name">南</td> 
        <td id="play_odds_607730" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607730" class="amount"><input type="text" /></td>
         
        <td id="play_name_607731" class="name">西</td> 
        <td id="play_odds_607731" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607731" class="amount"><input type="text" /></td>
         
        <td id="play_name_607732" class="name">北</td> 
        <td id="play_odds_607732" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607732" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_607733" class="name">中</td> 
        <td id="play_odds_607733" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607733" class="amount"><input type="text" /></td> 
        
        <td id="play_name_607734" class="name">发</td> 
        <td id="play_odds_607734" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607734" class="amount"><input type="text" /></td>
         
        <td id="play_name_607735" class="name">白</td> 
        <td id="play_odds_607735" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607735" class="amount"><input type="text" /></td>
