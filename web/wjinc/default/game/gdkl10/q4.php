...
<div class="main clearfix">
  ...
  <div id="subpage"> 
   <div class="cont-col3 klsf"> 
    ...
    <table class="u-table2 play_tab_78 K3Term"> 
      <thead> 
       <tr> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_607829" class="name">东</td> 
        <td id="play_odds_607829" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607829" class="amount"><input type="text" /></td> 
        
        <td id="play_name_607830" class="name">南</td> 
        <td id="play_odds_607830" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607830" class="amount"><input type="text" /></td>
         
        <td id="play_name_607831" class="name">西</td> 
        <td id="play_odds_607831" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607831" class="amount"><input type="text" /></td>
         
        <td id="play_name_607832" class="name">北</td> 
        <td id="play_odds_607832" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607832" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_607833" class="name">中</td> 
        <td id="play_odds_607833" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607833" class="amount"><input type="text" /></td> 
        
        <td id="play_name_607834" class="name">发</td> 
        <td id="play_odds_607834" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607834" class="amount"><input type="text" /></td>
         
        <td id="play_name_607835" class="name">白</td> 
        <td id="play_odds_607835" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_607835" class="amount"><input type="text" /></td>
