...
<div class="main clearfix">
  ...
  <div id="subpage"> 
   <div class="cont-col3 klsf"> 
    ...
    <table class="u-table2 play_tab_81 K3Term"> 
      <thead> 
       <tr> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_608129" class="name">东</td> 
        <td id="play_odds_608129" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608129" class="amount"><input type="text" /></td> 
        
        <td id="play_name_608130" class="name">南</td> 
        <td id="play_odds_608130" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608130" class="amount"><input type="text" /></td>
         
        <td id="play_name_608131" class="name">西</td> 
        <td id="play_odds_608131" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608131" class="amount"><input type="text" /></td>
         
        <td id="play_name_608132" class="name">北</td> 
        <td id="play_odds_608132" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608132" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_608133" class="name">中</td> 
        <td id="play_odds_608133" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608133" class="amount"><input type="text" /></td> 
        
        <td id="play_name_608134" class="name">发</td> 
        <td id="play_odds_608134" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608134" class="amount"><input type="text" /></td>
         
        <td id="play_name_608135" class="name">白</td> 
        <td id="play_odds_608135" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608135" class="amount"><input type="text" /></td>
