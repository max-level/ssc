...
<div class="main clearfix">
   ...
   <div class="cont-col3"> 
    ...
    <table class="u-table2 play_tab_67 XYNCTerm"> 
      <thead> 
       <tr> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_616729" class="name">东</td> 
        <td id="play_odds_616729" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616729" class="amount"><input type="text" /></td> 
        
        <td id="play_name_616730" class="name">南</td> 
        <td id="play_odds_616730" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616730" class="amount"><input type="text" /></td>
         
        <td id="play_name_616731" class="name">西</td> 
        <td id="play_odds_616731" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616731" class="amount"><input type="text" /></td>
         
        <td id="play_name_616732" class="name">北</td> 
        <td id="play_odds_616732" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616732" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_616733" class="name">中</td> 
        <td id="play_odds_616733" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616733" class="amount"><input type="text" /></td> 
        
        <td id="play_name_616734" class="name">发</td> 
        <td id="play_odds_616734" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616734" class="amount"><input type="text" /></td>
         
        <td id="play_name_616735" class="name">白</td> 
        <td id="play_odds_616735" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616735" class="amount"><input type="text" /></td>
