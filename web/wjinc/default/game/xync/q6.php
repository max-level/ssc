...
<div class="main clearfix">
   ...
   <div class="cont-col3"> 
    ...
    <table class="u-table2 play_tab_69 XYNCTerm"> 
      <thead> 
       <tr> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_616929" class="name">东</td> 
        <td id="play_odds_616929" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616929" class="amount"><input type="text" /></td> 
        
        <td id="play_name_616930" class="name">南</td> 
        <td id="play_odds_616930" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616930" class="amount"><input type="text" /></td>
         
        <td id="play_name_616931" class="name">西</td> 
        <td id="play_odds_616931" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616931" class="amount"><input type="text" /></td>
         
        <td id="play_name_616932" class="name">北</td> 
        <td id="play_odds_616932" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616932" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_616933" class="name">中</td> 
        <td id="play_odds_616933" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616933" class="amount"><input type="text" /></td> 
        
        <td id="play_name_616934" class="name">发</td> 
        <td id="play_odds_616934" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616934" class="amount"><input type="text" /></td>
         
        <td id="play_name_616935" class="name">白</td> 
        <td id="play_odds_616935" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616935" class="amount"><input type="text" /></td>
