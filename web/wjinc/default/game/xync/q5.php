...
<div class="main clearfix">
   ...
   <div class="cont-col3"> 
    ...
    <table class="u-table2 play_tab_68 XYNCTerm"> 
      <thead> 
       <tr> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_616829" class="name">东</td> 
        <td id="play_odds_616829" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616829" class="amount"><input type="text" /></td> 
        
        <td id="play_name_616830" class="name">南</td> 
        <td id="play_odds_616830" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616830" class="amount"><input type="text" /></td>
         
        <td id="play_name_616831" class="name">西</td> 
        <td id="play_odds_616831" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616831" class="amount"><input type="text" /></td>
         
        <td id="play_name_616832" class="name">北</td> 
        <td id="play_odds_616832" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616832" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_616833" class="name">中</td> 
        <td id="play_odds_616833" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616833" class="amount"><input type="text" /></td> 
        
        <td id="play_name_616834" class="name">发</td> 
        <td id="play_odds_616834" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616834" class="amount"><input type="text" /></td>
         
        <td id="play_name_616835" class="name">白</td> 
        <td id="play_odds_616835" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616835" class="amount"><input type="text" /></td>
