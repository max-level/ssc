   ...
   <div class="cont-col3"> 
    ...
    <table class="u-table2 play_tab_64 XYNCTerm"> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_616429" class="name">东</td> 
        <td id="play_odds_616429" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616429" class="amount"><input type="text" /></td> 
        
        <td id="play_name_616430" class="name">南</td> 
        <td id="play_odds_616430" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616430" class="amount"><input type="text" /></td>
         
        <td id="play_name_616431" class="name">西</td> 
        <td id="play_odds_616431" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616431" class="amount"><input type="text" /></td>
         
        <td id="play_name_616432" class="name">北</td> 
        <td id="play_odds_616432" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616432" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_616433" class="name">中</td> 
        <td id="play_odds_616433" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616433" class="amount"><input type="text" /></td> 
        
        <td id="play_name_616434" class="name">发</td> 
        <td id="play_odds_616434" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616434" class="amount"><input type="text" /></td>
         
        <td id="play_name_616435" class="name">白</td> 
        <td id="play_odds_616435" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616435" class="amount"><input type="text" /></td>
