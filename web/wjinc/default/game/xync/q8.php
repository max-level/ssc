...
<div class="main clearfix">
   ...
   <div class="cont-col3"> 
    ...
    <table class="u-table2 play_tab_80 XYNCTerm"> 
      <thead> 
       <tr> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_617129" class="name">东</td> 
        <td id="play_odds_617129" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_617129" class="amount"><input type="text" /></td> 
        
        <td id="play_name_617130" class="name">南</td> 
        <td id="play_odds_617130" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_617130" class="amount"><input type="text" /></td>
         
        <td id="play_name_617131" class="name">西</td> 
        <td id="play_odds_617131" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_617131" class="amount"><input type="text" /></td>
         
        <td id="play_name_617132" class="name">北</td> 
        <td id="play_odds_617132" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_617132" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_617133" class="name">中</td> 
        <td id="play_odds_617133" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_617133" class="amount"><input type="text" /></td> 
        
        <td id="play_name_617134" class="name">发</td> 
        <td id="play_odds_617134" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_617134" class="amount"><input type="text" /></td>
         
        <td id="play_name_617135" class="name">白</td> 
        <td id="play_odds_617135" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_617135" class="amount"><input type="text" /></td>
