...
<div class="main clearfix">
   ...
   <div class="cont-col3"> 
    ...
    <table class="u-table2 play_tab_65 XYNCTerm"> 
      <thead> 
       <tr> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_616529" class="name">东</td> 
        <td id="play_odds_616529" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616529" class="amount"><input type="text" /></td> 
        
        <td id="play_name_616530" class="name">南</td> 
        <td id="play_odds_616530" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616530" class="amount"><input type="text" /></td>
         
        <td id="play_name_616531" class="name">西</td> 
        <td id="play_odds_616531" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616531" class="amount"><input type="text" /></td>
         
        <td id="play_name_616532" class="name">北</td> 
        <td id="play_odds_616532" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616532" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_616533" class="name">中</td> 
        <td id="play_odds_616533" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616533" class="amount"><input type="text" /></td> 
        
        <td id="play_name_616534" class="name">发</td> 
        <td id="play_odds_616534" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616534" class="amount"><input type="text" /></td>
         
        <td id="play_name_616535" class="name">白</td> 
        <td id="play_odds_616535" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_616535" class="amount"><input type="text" /></td>
