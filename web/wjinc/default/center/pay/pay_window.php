...
<body>
	<div class="popup">
		<div class="popupinternal order-submit2">
			...
			<div class="col-left">
				...
				<table class="table" style="height: 150px">
					<tbody>
						...
						<tr id="copy_address_tr" class="hide">
							<td>地址：</td>
				...
				<div class="three-second">
					...
					<div class="post-info">
						...
						<!-- 
						<p>
							存款帐号：<input type="text" id="cardId">
						</p>
						 -->
						<p>
			...
			<div class="fullwidth">
				<div class="container">
					<input type="submit" class="button" id="btnSubmit1" onclick="doPay();" value="提交订单">
				</div>
			</div>
		...
		$(function() {
			...
			if(radio) {
				...
				if(code=="ZFB"){
					...
					$("#userName").attr("placeholder","请填写财付通昵称")
				}
				
				if(code == "WEIXIN" || code == "ZFB" || code == "CFT") {
