...
<div class="bannercontainer">
	<div class="banner">
		...
		<div class="subnavigation2">
			...
			<a href="/center/user/loginpwd.html"><div class="subitm2 subitmactive">登入密码</div></a>
			<a href="/center/user/fundpwd.html"><div class="subitm2">提款密码</div></a>
			<a href="/box/receive"><div class="subitm2">消息中心</div></a>
			<div class="arrow2a arrow arrow1"></div>
		</div>
	</div>
</div>	
	<div class="rightpanel rw" id="withdrawal1">
		<div class="contentcontainer">
		
		
			<div class="maincol innerline">
				<div class="row pagetitle">
					<span class="bluepagetitle">登入密码</span>  设置复杂的密码可提高帐号的安全性 
				</div>
				<div class="row">
					<div class="col1">当前密码 :</div>
					<div class="col2a">
						<input type="password" id="loginpwd" class="textbox2 ml5"> 
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col1">&nbsp;</div>
					<div class="col2a">
						<button class="btnsubmit ml5" onclick="User.updatePwd();" type="submit">确定</button>
					</div>
				</div>
			</div>
		</div>
