	...
	<div class="siderbar" id="left_main">
		<div class="side_left userctrl">
                    <ul>
						...
						<li class="r-wrap r-nowrap1 trial-cls link" style="display: none;"><a class="r-bg" href="javascript:;"onclick="window.open('/biapi/index.php?game=BB');"  target="framePage">BB体育</a></li>
...
<iframe id="mainIframe" name="mainIframe" src="/chat.html" frameborder="0" scrolling="auto" height="100%"></iframe>
</td>
  </tr>
</table>
