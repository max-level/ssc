...
function(e) {
	...
	o.modules = {}, o.status = {}, o.timeout = 10, o.event = {}, t.fn.define = function(e, t) {
		...
		return p.async = !0, p.charset = "utf-8", p.src = h +
		function() {
		...
		var s = (i || e).replace(/\.|\//g, ""),
			c = a.id = "layuicss-" + s,
			f = 0;
		a.rel = "stylesheet", a.href = e + (o.debug ? "?v=" + (new Date).getTime() : ""), a.media = "all", n.getElementById(c) || u.appendChild(a), "function" == typeof t && !
		function d() {
		...
		for (var t, n = (e || location.hash).replace(/^#/, "").split("/") || [], o = {
			dir: []
		}, i = 0; i < n.length; i++) t = n[i].split("="), /^\w+=/.test(n[i]) ?
		function() {
			"dir" !== t[0] && (o[t[0]] = t[1])
