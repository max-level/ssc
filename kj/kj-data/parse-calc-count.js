...
exports.JSK3ZH=function(bet, kj, Groupname, betInfo){
	...
	if(bet=='大'){
		if(kj[0]==kj[1] && kj[0]==kj[2]){
			return count;			
		}else if(kjhe>=11 && kjhe<=17){
			count=1;
		}
			return count;		
	 }else if(bet=='小'){
...
exports.gdklsf_zhonghe=function(bet, kj){
	...
	//	val+=parseInt(kj[i],10);
	//}
	var val=parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10)+parseInt(kj[5],10)+parseInt(kj[6],10)+parseInt(kj[7],10);
	//bet=bet.split('');
	//console.log(val+'testok');	
...
exports.GDKLSFZM=function(betData, kjData, Groupname){
	...
	for(var i=0; i<kj.length; i++){
		if(parseInt(bet,10)==parseInt(kj[i],10)) count=1;
	}
	return count;
}
//广东快乐十分正码结束
...
/*百家乐*+qi[ao*/
exports.sscbjl=function(bet, kj){
	var kjbet=bet.split(' ');kj=kj.split(',');
	var z=parseInt(kj[0])+parseInt(kj[1]);
	var x=parseInt(kj[3])+parseInt(kj[4]);
	if(z>=10) z=z%10;
	if(x>=10) x=x%10;
	if(z>x){
	    if(bet[0]=='庄') return 1;
	...
	if(kj[0]==kj[1]){
		if(bet[0]=='庄对子') return 2;
	}
	if(kj[3]==kj[4]){
		if(bet[0]=='闲对子') return 2;
	}
	if(z==8 || z==9){
		if(bet[0]=='庄天王') return 5;
	}
	if(x==8 || x==9){
		if(bet[0]=='闲天王') return 5;
	}
}

exports.sscniuniu=function(bet, kj){
var kj=kj.split(',');
	var cn = ['一','二','三','四','五','六','七','八','九','牛'];
	if((parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10))%10 ==0 ){
		var a =parseInt(kj[3])+parseInt(kj[4]);if(a>10) a=a-10;
		var b = '牛'+cn[a];
		if(bet.indexOf(b)!=-1) count=1; 
	 }
	if((parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[3],10))%10 ==0 ){
		var a =parseInt(kj[2])+parseInt(kj[4]);if(a>10) a=a-10;
		var b = '牛'+cn[a];
		if(bet.indexOf(b)!=-1) count=1; 
	}
	if((parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[4],10))%10 ==0 ){
		var a =parseInt(kj[2])+parseInt(kj[3]);if(a>10) a=a-10;
		var b = '牛'+cn[a];
		if(bet.indexOf(b)!=-1) count=1; 
	}
	if((parseInt(kj[0],10)+parseInt(kj[2],10)+parseInt(kj[3],10))%10 ==0 ){
		var a =parseInt(kj[1])+parseInt(kj[4]);if(a>10) a=a-10;
		var b = '牛'+cn[a];
		if(bet.indexOf(b)!=-1) count=1; 
	}
	if((parseInt(kj[0],10)+parseInt(kj[2],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[1])+parseInt(kj[3]);if(a>10) a=a-10;
		var b = '牛'+cn[a];
		if(betData.indexOf(b)!=-1) count=1; 
	}
	if((parseInt(kj[0],10)+parseInt(kj[3],10)+parseInt(kj[4],10))%10 ==0 ){
		var a =parseInt(kj[1])+parseInt(kj[2]);if(a>10) a=a-10;
		var b = '牛'+cn[a];
		if(bet.indexOf(b)!=-1) count=1; 
	}
	if((parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[4]);if(a>10) a=a-10;
		var b = '牛'+cn[a];
		if(bet.indexOf(b)!=-1) count=1; 
	}
	if((parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[3]);if(a>10) a=a-10;
		var b = '牛'+cn[a];
		if(bet.indexOf(b)!=-1) count=1; 
	}
	if((parseInt(kj[1],10)+parseInt(kj[3],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[2]);if(a>10) a=a-10;
		var b = '牛'+cn[a];
		if(bet.indexOf(b)!=-1) count=1; 
	}
	if((parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[1]);if(a>10) a=a-10;
		var b = '牛'+cn[a];
		if(bet.indexOf(b)!=-1) count=1; 
	}
  return count;
...
//重庆时时彩总和大小单双+龙虎斗玩法
exports.ssclhwq=function(bet, kj){
	var kj=kj.split(',');
...
exports.cqsscgy=exports.ssclhwq
exports.ssclhwb=exports.ssclhwq
exports.ssclhws=exports.ssclhwq
exports.ssclhwg=exports.ssclhwq
exports.ssclhqb=exports.ssclhwq
exports.ssclhqs=exports.ssclhwq
exports.ssclhqg=exports.ssclhwq
exports.ssclhbs=exports.ssclhwq
exports.ssclhbg=exports.ssclhwq
exports.ssclhsg=exports.ssclhwq
...
exports.ssczheng=function(bet, kj){
	var kj=kj.split(',');
	var val=parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10);
	var val1=val%4;
	var count=0;
...
exports.sscjiao=function(bet, kj){
	var kj=kj.split(',');
	var val=parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10);
	var val1=val%4;
	var count=0;
			 if(bet=='1-2角'){
				if(val1==1||val1==2) count=1;
				return count;
			}else if(bet=='2-3角'){
				if(val1==3||val1==2) count=1;
				return count;
			}else if(bet=='3-4角'){
				if(val1==3||val1==0) count=1;
				return count;
			}else if(bet=='1-4角'){
				if(val1==1||val1==0) count=1;
				return count;
			}
}

exports.sscfan=function(bet, kj){
	var kj=kj.split(',');
	var val=parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10);
	var val1=val%4;
...
exports.fands=function(bet, kj){
	...
	var count=0;
			 if(bet=='单'){
				if(val1==1||val1==3) count=1;
				return count;
			}else if(bet=='双'){
				if(val1==0||val1==2) count=1;
				return count;
			}
	
}

exports.sscnian=function(bet, kj){
	var kj=kj.split(',');
	var val=parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10);
	var val1=val%4;
...
//北京PK10和幸运飞艇综合玩法结束
exports.pkzheng=function(bet, kj){
	var kj=kj.split(',');
	var val=parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10);
	var val1=val%4;
	var count=0;
...
exports.pkjiao=function(bet, kj){
	var kj=kj.split(',');
	var val=parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10);
	var val1=val%4;
	var count=0;
...
exports.pknian=function(bet, kj){
	var kj=kj.split(',');
	var val=parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10);
	var val1=val%4;
